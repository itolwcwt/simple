...
class Category(models.Model):
    ...
    title = models.TextField('显示', max_length=200, default='')
...
class Article(models.Model):
    ...
    """
    内容作者，这里User是从django.contrib.auth.models导入的。
    这里通过 ForeignKey 把内容和 User 关联了起来。
    """
    ...
    def get_absolute_url(self):
        return reverse('front:category_show', args=[self.id])
